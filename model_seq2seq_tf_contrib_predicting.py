...
from model_seq2seq_tf_contrib_training import load_data, make_vocab, get_batch
from model_seq2seq_tf_contrib_training import Config
...
if __name__ == "__main__":
	...
	model = Seq2seq(config=config, w2i_target=w2i_target, Flag_TeacherForcing=False, Flag_Attention=True, Option_BeamSearch=5)
